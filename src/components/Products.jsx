...
const Products = () => {
  return (
    <>
      <section className="bg_body position-relative py-5 mb-xl-5">
            ...
            {/* {Products.map((phone) => {
              return (
                <Col lg={4} md={6} key={phone.id} className="py-4 ">
                  <div className="d-flex flex-column align-items-center bg_pro pb-lg-5 py-3 bg_blur  px-4 hover_pro transition_300ms h-100">
                    <div className="pt-5">
                    ...
                    <p className="ff_rubuik fw-normal fs_md color_whitelight text-center pt-2  mb-xl-5">
                      SCal Mobile houses premium quality iPhones that are
                      available at ultra-competitive prices. From the latest
                      models to update your collection to old phones in perfect
                      condition, at SCal Mobile, you will find everything you
                      need in numerous colors and storage capacities.
                    </p>
                  </div>
                </Col>
              );
